...
const Groceries = () => {
    ...
    const [activeData, setActiveData] = useState('Groceries')
  ...
  return (
    ...
    <div className="container-fluid" style={{ marginBottom: '20px', padding: '25px 45px', backgroundColor: '#d8f1e5', borderRadius: '20px', width: '1260px', margin: '0 auto' }}>
        ...
        <div className="container-fluid " style={{ padding: '25px 45px' }}>
            ...
            <div className="row">
                ...
                <div className="sideBar">
                    ...
                    <img src={sidebanner} alt='Error'  className='m' />
                    </div>
                    <div className="card p-0">
